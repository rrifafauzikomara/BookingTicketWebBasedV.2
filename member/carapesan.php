...
<body>
    ...
    <div class="col-lg-6">
        ...
        <div class="col-5" style="text-align: left;">
            <img src="../images/cm1.png" alt="" style="width: 50%;"/>
        </div>
        <div class="col-5" style="text-align: left;">
            <a href="http://localhost/primajasa/member/booking.php">Klik Disini</a>
        </div>
    </div>
    <!-- /.col-lg-6 -->
    ...
    <div class="col-lg-6">
        ...
        <div class="col-5" style="text-align: left;">
            <img src="../images/cm2.png" alt="" style="width: 50%;"/>
        </div>
        <div class="col-5" style="text-align: left;">
            <a href="http://localhost/primajasa/member/booking.php">Klik Disini</a>
        </div>
    ...
    <div class="col-lg-6">
        ...
        <div class="col-5" style="text-align: left;">
            <img src="../images/cm3.png" alt="" style="width: 50%;"/>
        </div>
        <div class="col-5" style="text-align: left;">
            <a href="http://localhost/primajasa/member/booking.php">Klik Disini</a>
        </div>
    ...
    <div class="col-lg-6">
        ...
        <div class="col-5" style="text-align: left;">
            <img src="../images/cm4.png" alt="" style="width: 50%;"/>
        </div>
        <div class="col-5" style="text-align: left;">
            <a href="http://localhost/primajasa/member/booking.php">Klik Disini</a>
        </div>
