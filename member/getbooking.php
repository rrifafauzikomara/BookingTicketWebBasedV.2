...
?>
                                    ...
                                    <form class="form-horizontal form-label-left" method="get" action=""  enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tgl_kebm">Tanggal Keberangkatan</label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="tgl_kebm" class="form-control col-md-7 col-xs-12" name="tgl_kebm" type="datetime" value="<?php echo date("Y-m-d H:i:s",strtotime('+3 hours'));?>" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">Jumlah Pemesanan </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input type="number" min="1" max="39" value="0" name="qty" step="1" data-validate-length="0" class="form-control col-md-7 col-xs-12" placeholder="">
                                        </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="" class="control-label col-md-3">Harga </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" name="otiket" class="form-control col-md-7 col-xs-12" readonly>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="" class="control-label col-md-3">Sub Total </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" name="osub" class="form-control col-md-7 col-xs-12" readonly>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="" class="control-label col-md-3">Discount </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" name="odiskon" class="form-control col-md-7 col-xs-12" readonly>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="" class="control-label col-md-3">Total </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" name="ototal" class="form-control col-md-7 col-xs-12" readonly>
                                            </div>
                                        </div>
