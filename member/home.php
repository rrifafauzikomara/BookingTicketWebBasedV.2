...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><center>Visi Dan Misi PT Bus Primajasa</center></h2>
            </div>
        </div>
        <!-- /.row -->
        <div class="well">
            <h4>VISI:<br><br>
            Menjadi perusahaan Transportasi Darat yang Terkemuka dan Terpercaya di Indonesia yang dilandasi oleh nilai-nilai Religius<br><br><br>
            MISI:<br><br>
            • Pelayanan masyarakat<br>
            • Mematuhi seluruh peraturan PerUndang-undangan yang berlaku<br>
            • Selalu memperhatikan dan memelihara lingkungan hidup<br>
            • Serta mengikuti perkembangan ilmu dan tekhnologi<br>
            • Dan tuntutan pelayanan yang semakin meningkat<br></h4>
            <h2>&nbsp;</h2>
<h4 align="center"><em>“Ekonomis, Tepat Waktu, Aman, Nyaman dan Delightful Traveling”</em></h4>

        </div>

        <div class="well">
            <h3><center>Terimakasih telah menjadi member di perusahaan PT Perimajasa</center></h3> 
            <h2>&nbsp;</h2>
