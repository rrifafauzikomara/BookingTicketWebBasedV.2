...
<body>
        ...
        <!-- /.row -->
                ...
                <fieldset>
                    <?php
                        ...
                        $i = 0; //counter
                        $no_pesanm = ""; //our default pin is blank.
                        while($i < $digits){
                            //generate a random number between 0 and 9.
                            $no_pesanm .= mt_rand(0, 9);
                            $i++;
                        }
                        return $no_pesanm;
                        }
                        ...
                        $no_pesanm = generatePIN();
                    ?>
                    

                                    <form action="" method="post" class="form-horizontal form-label-left" name="form">
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_pesanm">No Booking <span class="required"></span>
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="disabledInput" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-number="4" name="no_pesanm" placeholder="" required="required" type="text" value="<?php echo $no_pesanm; ?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">No KTP </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          <input id="" type="text" name="no_ktpm" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" value="<?php echo $_SESSION['ktp']; ?>" readonly="true">
                                          <input type="hidden" name="id_jadwal" value="<?php echo $_GET['route']; ?>">
                                          <input type="hidden" name="tgl_kebm" value="<?php echo $_GET['tgl_kebm']; ?>">
                                          <input type="hidden" name="hargam" value="<?php echo $_GET['otiket']; ?>">  
                                          <input type="hidden" name="subm" value="<?php echo $_GET['osub']; ?>">
                                          <input type="hidden" name="diskon" value="<?php echo $_GET['odiskon']; ?>">  
                                        <input type="hidden" name="totalm" value="<?php echo $_GET['ototal']; ?>">
                                        </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">Nama Lengkap </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          <input id="" type="text" name="namam" value="<?php echo $_SESSION['nama']; ?>" readonly="true" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="Masukan Nama Lengkap">
                                        </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">Nama Orang Ke 2 </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          <input id="" type="text" name="nama2ndm" value="" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="Masukan Nama Orang Ke 2">
                                        </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">Alamat Lengkap </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          <input id="" type="text" name="alamatm" value="<?php echo $_SESSION['alamat']; ?>" readonly="true" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="Masukan Alamat Lengkap">
                                        </div>
                                        </div>
                                        <div class="item form-group">
                                        <label for="" class="control-label col-md-3">No Handphone </label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          <input id="" type="text" name="kontakm" value="<?php echo $_SESSION['hp']; ?>" readonly="true" data-validate-length-range="5,12" class="optional form-control col-md-7 col-xs-12" placeholder="Masukan No Hp atau Telephone">
                                        </div>
                                        </div>
                                        <div class="item form-group">
                                        <br>
                                       ...
                                       <script type="text/javascript" language="javascript">
                                        ...
                                        function limitchex(oCheckbox, limit) 
                                        {
                                         ...
                                         $query=mysqli_query($con,"Select * from tb_member where seatm='$i'");
                                         ...
                                         if($num_rows < 1) {
                                         ?>
                                         <input type="checkbox" class="single-checkboxchk" name="seatm[]" value="<?php echo $i; ?>" onclick="return limitchex(this,<?php echo $_GET['qty']; ?>)"/> 
                                         <?php
                                         }
                                         else
                                         {
                                         ?>
                                         <input type="checkbox" class="single-checkbox" name="seatm[]" value="<?php echo $i; ?>" checked disabled/>
                                         <?php
    ...
    if (@$_POST['pesan']) {
        ...
        $no_ktpm = $_POST['no_ktpm'];
        $namam= $_POST['namam'];
        $nama2ndm = $_POST['nama2ndm'];
        $alamatm = $_POST['alamatm'];
        $kontakm = $_POST['kontakm'];
       
        
            if ($no_pesanm == '' || $no_ktpm == '' || $namam == '' || $nama2ndm == '' || $alamatm == '' || $kontakm == '') {
                    ?> <script type="text/javascript">alert("Inputan tidak boleh kosong !!");</script> <?php
                } else {
                     foreach($_POST['seatm'] as $checkboxes) {
                 $seatm=$checkboxes;
              $sql_insert = "insert into tb_member(no_pesanm,no_ktpm,namam,nama2ndm,alamatm,kontakm,seatm,id_jadwal,tgl_kebm,jml_tiketm,hargam,subm,diskon,totalm) values ('$no_pesanm' ,'$no_ktpm', '$namam', '$nama2ndm', '$alamatm', '$kontakm', '$seatm', '$_POST[id_jadwal]','$_POST[tgl_kebm]', '$_GET[qty]','$_POST[hargam]','$_POST[subm]','$_POST[diskon]','$_POST[totalm]')" or die (mysqli_error());
              $pesan = mysqli_query($con, $sql_insert);
                ...
                if ($pesan) {
                    ...
                    echo "<script type=text/javascript>
                                window.location.href='http://localhost/primajasa/member/print.php?id=$no_pesanm';
                                </script>" ;
                    }
                }
