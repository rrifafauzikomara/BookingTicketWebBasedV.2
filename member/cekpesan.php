        ...
        <div class="well">
            <fieldset>
                <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                    ...
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_booking">No Booking <span class="required"></span></label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                    <input id="no_booking" value="" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-number="4" name="no_booking" placeholder="" required="required" type="text">
                    </div>
                    </div>
