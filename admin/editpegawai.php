                ...
                <div class="well">
                    ...
                    <?php
					   include "../inc/koneksi.php";
                        ...
                        if ($tambah) {
                            if ($nama == "" || $email == "" || $nohp == "" || $alamat == "" || $username == "" || $password == "") {
                                    ?> <script type="text/javascript">alert("Inputan tidak boleh kosong !!");</script> <?php
                            } else {
                                $sql_update = "update tb_pegawai set nama='$nama', email='$email', nohp='$nohp', alamat='$alamat',username='$username', password='$password' where id='$id'" or die (mysqli_error());
                                $update = mysqli_query($con, $sql_update);
                                
								echo "<script type=text/javascript>
								window.location.href='http://localhost/primajasa/admin/datapegawai.php';
								</script>" ;
							}
                        }
									 
							$sql = "select * from tb_pegawai where id='$_GET[id]'" or die (mysqli_error());
                                        ...
                                        <div class="item form-group">
                                           <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input value="<?php echo $data['nama']; ?>" type="text" id="nama" name="nama" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" placeholder="Masukan Nama Lengkap">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input value="<?php echo $data['email']; ?>" id="email" type="text" name="email"  data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="Masukan Email">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nohp"> No Telephone<span class="required"></span>
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input value="<?php echo $data['nohp']; ?>" id="nohp" type="text" name="nohp" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan No Hp atau Tlp">
                                            </div>
                                        </div>
                                        <div class="item form-group">
