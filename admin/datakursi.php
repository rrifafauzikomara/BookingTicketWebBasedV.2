        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Data Jumlah Kursi
                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                        ...
                        <h2 class="page-header">Lihat Data Kursi</h2>
                        <div class="jumbotron">
                        <fieldset>
                        ...
                        <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                            ...
                            <?php
                            $sql = "select * from tb_kursi" or die (mysqli_error());
                            ...
                            <tr>
                                ...
                                <td align="center"><a  href="editkursi.php?id=<?php echo $data['Id']; ?>" class="btn btn-xs btn-default" title="Edit" >
