					   ...
					   include "../inc/koneksi.php";
                        ...
                        if ($tambah) {
                            if ($id == "" || $jumlah == "") {
                                ...
                                $sql_update = "update tb_kursi set Jumlah_Kursi='$jumlah' where id='$id'" or die (mysqli_error());
                                $update = mysqli_query($con, $sql_update);
                                
								echo "<script type=text/javascript>
								window.location.href='http://localhost/primajasa/admin/datakursi.php';
								</script>" ;
							}
                        }
									 
									 $sql = "select * from tb_kursi where id='$_GET[id]'" or die (mysqli_error());
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_supir">Id <span class="required"></span>
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="id" value="<?php echo $data['Id']; ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-number="4" name="id" placeholder="" required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_supir"> Jumlah Kursi <span class="required"></span>
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" id="nama_supir" value="<?php echo $data['Jumlah_Kursi']; ?>" name="jumlah" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" placeholder="Masukan Jumlah Kursi">
                                            </div>
                                        </div>
