            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="number" min="0" id="no_ktp" name="no_ktp" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" placeholder="Masukan No KTP Anda">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="no_hp" type="number" min="0"  name="no_hp" data-validate-length-range="10,12" class="optional form-control col-md-7 col-xs-12" maxlength="12" placeholder="Masukan No Hp atau Tlp">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="email" type="email" name="email"  data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="Masukan Email">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                    ...
                    <?php
                        ...
                        if ($tambah) {
                            if ($no_ktp == "" || $nama_user == "" || $alamat == "" || $no_hp == "" || $email == "" || $username == "" || $password == "" || $level == "") {
                                    ?> <script type="text/javascript">alert("Inputan tidak boleh kosong !!");</script> <?php
                            } else {
                                $sql_tambah = "insert into tb_registrasi values('', '$no_ktp', '$nama_user', '$alamat', '$no_hp', '$email', '$username', '$password', '$level')" or die (mysqli_error());
