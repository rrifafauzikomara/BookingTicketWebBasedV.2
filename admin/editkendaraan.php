                       ...
                       include "../inc/koneksi.php";
                        ...
                        if ($tambah) {
                            if ($id_kendaraan == "" || $jenis_kendaraan == "" || $no_polisi == "") {
                                ...
                                $sql_update = "update tb_kendaraan set jenis_kendaraan='$jenis_kendaraan',no_polisi='$no_polisi' where id_kendaraan='$id_kendaraan'" or die (mysqli_error());
                                ...
                                window.location.href='http://r-fauzi.xyz/admin/datakendaraan.php';
                                     ...
                                     $sql = "select * from tb_kendaraan where id_kendaraan='$_GET[id]'" or die (mysqli_error());
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="id_kendaraan" value="<?php echo $data['id_kendaraan']; ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-number="4" name="id_kendaraan" placeholder="" required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" id="jenis_kendaraan" value="<?php echo $data['jenis_kendaraan']; ?>" name="jenis_kendaraan" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" placeholder="">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input id="no_polisi"  type="text" value="<?php echo $data['no_polisi']; ?>" name="no_polisi"  data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12" placeholder="">
                                            </div>
                                        </div>
