...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
        <div class="col-lg-12">
            <h4><center>"Jika Ada Kendala Dalam Melakukan Pemesanan Silahkan Klik Di Bawah Ini"</center></h4>
        </div>
    </div>
    <center><button><a href="cs.php">Hubungi Customer Service</a></button></center>
